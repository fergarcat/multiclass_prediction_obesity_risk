...
def download_kaggle_competition(competition_name: str, destination: str = "../data/.kaggle", unzip: bool = True):
    """
...
if __name__ == "__main__":
    ...
    download_kaggle_competition("playground-series-s4e2",destination = destination_path)
